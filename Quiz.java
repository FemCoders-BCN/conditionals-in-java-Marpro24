...
public class Quiz {
    public static void main(String[] args) {
        ...
        System.out.println("Bienvenida al Quiz de mujeres en el mundo tech!");
        System.out.println(
                "Cada respuesta correcta suma 5 puntos. Si si hay más de una respuesta correcta, deberás introducir ambas respuestas separadas por una coma");
        System.out.println();
        ...
        String thirdQ = quiz.nextLine().trim().toLowerCase().replace(" ", "");

        if (thirdQ.equals("b,d") || thirdQ.equals("d,b")) {
         ...
         * b. Una actriz de cine
         * c. Inventora del procesador de datos
         * d. Inventora del sistema de comunicaciones de salto de frecuencia, base del
         * wifi, bluetooth y GPS
         * 
         * 4. ¿Cómo se llamaban las principales 'mujeres ocultas' de la NASA, encargadas
         * de los cálculos para que la misión del Apolo 11 concluyera con éxito?
         * a. Katherine Johnson, Dorothy Vaughan y Mary Jackson
         * b. Jessica Miller, Emily Johnson, Sarah Davis
         * c. bell hooks, Toni Morrison y Alice Walker
         * d. Emmeline Pankhurst, Millicent Fawcett y Harriet Harman
         */
        System.out.println("\nTienes un total de " + counter + "/20 puntos");
